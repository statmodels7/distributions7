...
.ctor_args <- list(betabinom1_distrib = list(size = 10),
                   ...
                   mvgaussian1_distrib = list(n_dim = 2),
                   mvgaussian2_distrib = list(n_dim = 2),
                   mvstudent_t1_distrib = list(n_dim = 2),
                   mvstudent_t2_distrib = list(n_dim = 2),
...
`mvstudent_t1_distrib()` is the heavy-tailed alternative, with the degrees of
