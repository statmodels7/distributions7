...
Eighteen univariate distributions and two multivariate ones ship with the
package. Each constructor takes the link functions used for its parameters,
and parameters travel as a named list.
