...
``` r
gengamma_distrib(link_a = log_link(), link_d = log_link(), link_p = log_link())
```
...
An S7 object of class `GenGammaDistrib`.
...
- \\p = 1\\ is the
  [gamma](https://statmodels7.github.io/distributions7/reference/gamma_distrib.md)
  with shape \\d\\ and scale \\a\\;

- \\d = p\\ is the
  [Weibull](https://statmodels7.github.io/distributions7/reference/weibull_distrib.md)
...
- \\p \to 0\\ with \\d/p\\ held large approaches the
  [lognormal](https://statmodels7.github.io/distributions7/reference/lognormal_distrib.md).
