...
A subclass of `multivariate_distrib` representing the multinomial
distribution, the first multivariate family here whose support is a set
of points rather than a region.
...
- param:
  ...
  The parameters7 simplex carrying the probabilities.

## Value

An object of class `MultinomialDistrib`.
