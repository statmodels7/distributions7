...
A subclass of `discrete_distrib` representing the zero-adjusted (hurdle)
version of a wrapped discrete distribution: the probability mass at zero
is *replaced* by \\\pi\\ (parameter `za`), and positive values follow
