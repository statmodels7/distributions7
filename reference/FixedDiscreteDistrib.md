...
A subclass of `discrete_distrib` representing a discrete distribution in
which some parameters of the wrapped distribution are held at known
values. Constructed by
