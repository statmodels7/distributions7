...
The parent's score recentered by its truncated mean, \\d_i \ell_T =
s_i(y) - m_i\\.
...
binomial's size – but it does add a \\\theta\\-dependent normalizing
constant, and the recentering is that constant's contribution. The
