...
readable, so a larger distribution is rejected with the suggestion of
...
shape means, and computing a probability level would need the orthant
integral this package does not approximate in several dimensions.
