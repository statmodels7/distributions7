...
Refused. A scalar skewness for a vector response is not one quantity but
a choice among several – Mardia's, Malkovich-Afifi's, or the vector of
coordinatewise marginal skewnesses – and they do not agree. Returning
...
smaller multivariate distribution and refuses in turn; it is for the
