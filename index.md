...
[distributions7](https://statmodels7.github.io/distributions7) describes
probability distributions as S7 objects that carry not just the usual
density, distribution and quantile functions, but the **exact analytical
...
unconstrained parameters behind a link function.

It is the distribution layer of
[statmodels7](https://github.com/statmodels7), an S7 stack for
statistical modelling, and it works alongside
