...
#' @description Closed-form third-order derivatives of the Lognormal log-density (observed, or expected when `expected = TRUE`).
#' @param distrib A `Lognormal1Distrib` object.
#' @param y A numeric vector of observations.
#' @param theta A list containing the parameters `mu` and `sigma2`.
...
#' @description Closed-form fourth-order derivatives of the Lognormal log-density (observed, or expected when `expected = TRUE`).
#' @param distrib A `Lognormal1Distrib` object.
#' @param y A numeric vector of observations.
#' @param theta A list containing the parameters `mu` and `sigma2`.
...
#'
#' **Moments:** mean \eqn{e^{\mu + \sigma^2/2}}, variance
...
#'
#' @return An S7 object of class `Lognormal1Distrib` (inheriting from `continuous_distrib`) representing the Lognormal distribution.
#'
...
#'
#' @seealso [lognormal2_distrib()], [gaussian1_distrib()]
#' @export
