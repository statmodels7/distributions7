...
#' @description Closed-form third-order derivative of the Bernoulli log-mass (observed, or expected when `expected = TRUE`).
#' @param distrib A `BernoulliDistrib` object.
#' @param y A numeric vector of observations.
#' @param theta A list containing the parameter `mu`.
...
#' @description Closed-form fourth-order derivative of the Bernoulli log-mass (observed, or expected when `expected = TRUE`).
#' @param distrib A `BernoulliDistrib` object.
#' @param y A numeric vector of observations.
#' @param theta A list containing the parameter `mu`.
...
#'
#' **Moments:** mean \eqn{\mu}, variance \eqn{\mu(1-\mu)},
