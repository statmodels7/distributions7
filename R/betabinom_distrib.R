...
#' @return An object of class \code{BetaBinomDistrib}.
#' @seealso \code{\link{betabinom_distrib}}
#'
#' @section Methods:
#' Methods implemented for this class:
#'   \code{\link[=distrib_cdf.BetaBinomDistrib]{distrib_cdf()}},
#'   \code{\link[=distrib_expected_hessian.BetaBinomDistrib]{distrib_expected_hessian()}},
#'   \code{\link[=distrib_gradient.BetaBinomDistrib]{distrib_gradient()}},
#'   \code{\link[=distrib_hessian.BetaBinomDistrib]{distrib_hessian()}},
#'   \code{\link[=distrib_pdf.BetaBinomDistrib]{distrib_pdf()}},
#'   \code{\link[=distrib_quantile.BetaBinomDistrib]{distrib_quantile()}},
#'   \code{\link[=distrib_rng.BetaBinomDistrib]{distrib_rng()}}
#'
...
BetaBinomDistrib <- S7::new_class("BetaBinomDistrib",
...
#' @seealso \code{\link{betabinom_distrib}}
S7::method(distrib_cdf, BetaBinomDistrib) <- function(distrib, q, theta,
                                                      lower.tail = TRUE,
                                                      log.p = FALSE) {
  n <- distrib@size
  supp <- 0:n
...
#' @name distrib_quantile.BetaBinomDistrib
...
#' @seealso \code{\link{betabinom_distrib}}
S7::method(distrib_quantile, BetaBinomDistrib) <- function(distrib, p, theta,
                                                            lower.tail = TRUE,
                                                            log.p = FALSE) {
  if (log.p) p <- exp(p)
  if (!lower.tail) p <- 1 - p
...
#' @name distrib_rng.BetaBinomDistrib
...
#' @seealso \code{\link{betabinom_distrib}}
S7::method(distrib_rng, BetaBinomDistrib) <- function(distrib, n, theta) {
  a <- theta[[1]] / theta[[2]]
  b <- (1 - theta[[1]]) / theta[[2]]
...
#' @name distrib_gradient.BetaBinomDistrib
#' @description
...
#' @seealso \code{\link{betabinom_distrib}}
S7::method(distrib_gradient, BetaBinomDistrib) <- function(distrib, y, theta,
                                                            scale = c("parameter", "link"), ...) {
  betabinom_gradient_cpp(y, theta[[1]], theta[[2]], distrib@size)
}

#' @title Beta-Binomial Analytical Observed Hessian
#' @name distrib_hessian.BetaBinomDistrib
#' @description
...
#' @seealso \code{\link{betabinom_distrib}}
S7::method(distrib_hessian, BetaBinomDistrib) <- function(distrib, y, theta,
                                                           scale = c("parameter", "link"), ...) {
  betabinom_hessian_cpp(y, theta[[1]], theta[[2]], distrib@size)
}

#' @title Beta-Binomial Analytical Expected Hessian
#' @name distrib_expected_hessian.BetaBinomDistrib
#' @description
...
#' @seealso \code{\link{betabinom_distrib}}
S7::method(distrib_expected_hessian, BetaBinomDistrib) <- function(distrib, y, theta,
                                                                    scale = c("parameter", "link"),
...
#' give.
#'
#' @return An S7 object of class \code{BetaBinomDistrib}.
#'
#' @seealso \code{\link{binomial_distrib}}, \code{\link{beta_distrib}},
#'   \code{\link{negbin_distrib}}
#'
...
#'
#' @export
betabinom_distrib <- function(size, link_mu = logit_link(),
                              link_sigma = log_link()) {
