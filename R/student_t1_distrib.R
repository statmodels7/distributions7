...
#' @return An object of class \code{StudentT1Distrib}.
#' @seealso \code{\link{student_t1_distrib}}
#'
#' @section Methods:
#' Methods implemented for this class:
#'   \code{\link[=distrib_cdf.StudentT1Distrib]{distrib_cdf()}},
#'   \code{\link[=distrib_deriv3.StudentT1Distrib]{distrib_deriv3()}},
#'   \code{\link[=distrib_deriv4.StudentT1Distrib]{distrib_deriv4()}},
#'   \code{\link[=distrib_expected_hessian.StudentT1Distrib]{distrib_expected_hessian()}},
#'   \code{\link[=distrib_grad_y.StudentT1Distrib]{distrib_grad_y()}},
#'   \code{\link[=distrib_gradient.StudentT1Distrib]{distrib_gradient()}},
#'   \code{\link[=distrib_hess_y.StudentT1Distrib]{distrib_hess_y()}},
#'   \code{\link[=distrib_hessian.StudentT1Distrib]{distrib_hessian()}},
#'   \code{\link[=distrib_pdf.StudentT1Distrib]{distrib_pdf()}},
#'   \code{\link[=distrib_quantile.StudentT1Distrib]{distrib_quantile()}},
#'   \code{\link[=distrib_rng.StudentT1Distrib]{distrib_rng()}}
#'
...
#' The observed Hessian is available via \code{\link{distrib_hessian.StudentT1Distrib}}.
#'
...
#' @seealso
#' \itemize{
#'   \item \code{\link{distrib_pdf.StudentT1Distrib}} for the probability density function.
#'   \item \code{\link{distrib_cdf.StudentT1Distrib}} for the cumulative distribution function.
#'   \item \code{\link{distrib_quantile.StudentT1Distrib}} for the quantile function.
#'   \item \code{\link{distrib_rng.StudentT1Distrib}} for random number generation.
#'   \item \code{\link{distrib_gradient.StudentT1Distrib}} for the analytical gradient.
#'   \item \code{\link{distrib_hessian.StudentT1Distrib}} for the analytical observed Hessian.
#'   \item \code{\link{distrib_expected_hessian.StudentT1Distrib}} for the analytical expected Hessian.
#' }
#'
#' @return An S7 object of class \code{StudentT1Distrib} (inheriting from \code{continuous_distrib}) representing the Student's t distribution.
#'
