...
#' @name NegBin2Distrib
#'
#' @description A subclass of `discrete_distrib` representing the Negative Binomial distribution (NB2 parameterization).
#' @inheritParams distrib
#' @return An object of class `NegBin2Distrib`.
...
#' @param theta A list containing the parameters `mu` and `theta`.
...
#'
#' **Observed Hessian** (\eqn{\psi_1} the trigamma function):
...
#'
#' **Moments:** mean \eqn{\mu}, variance \eqn{\mu + \mu^2/\theta},
