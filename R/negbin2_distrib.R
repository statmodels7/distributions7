...
#' @return An object of class \code{NegBin2Distrib}.
#' @seealso \code{\link{negbin2_distrib}}
#'
#' @section Methods:
#' Methods implemented for this class:
#'   \code{\link[=distrib_cdf.NegBin2Distrib]{distrib_cdf()}},
#'   \code{\link[=distrib_deriv3.NegBin2Distrib]{distrib_deriv3()}},
#'   \code{\link[=distrib_deriv4.NegBin2Distrib]{distrib_deriv4()}},
#'   \code{\link[=distrib_expected_hessian.NegBin2Distrib]{distrib_expected_hessian()}},
#'   \code{\link[=distrib_gradient.NegBin2Distrib]{distrib_gradient()}},
#'   \code{\link[=distrib_hessian.NegBin2Distrib]{distrib_hessian()}},
#'   \code{\link[=distrib_pdf.NegBin2Distrib]{distrib_pdf()}},
#'   \code{\link[=distrib_quantile.NegBin2Distrib]{distrib_quantile()}},
#'   \code{\link[=distrib_rng.NegBin2Distrib]{distrib_rng()}},
...
#' @seealso
#' \itemize{
#'   \item \code{\link{distrib_pdf.NegBin2Distrib}} for the probability mass function.
#'   \item \code{\link{distrib_cdf.NegBin2Distrib}} for the cumulative distribution function.
#'   \item \code{\link{distrib_quantile.NegBin2Distrib}} for the quantile function.
#'   \item \code{\link{distrib_rng.NegBin2Distrib}} for random number generation.
#'   \item \code{\link{distrib_gradient.NegBin2Distrib}} for the analytical gradient.
#'   \item \code{\link{distrib_hessian.NegBin2Distrib}} for the analytical observed Hessian.
#'   \item \code{\link{distrib_expected_hessian.NegBin2Distrib}} for the analytical expected Hessian.
#' }
#'
#' @return An S7 object of class \code{NegBin2Distrib} (inheriting from \code{discrete_distrib}) representing the Negative Binomial distribution.
#'
