...
#' @seealso \code{\link{lognormal_distrib}}
S7::method(distrib_gradient, LognormalDistrib) <- function(distrib, y, theta, scale = c("parameter", "link"), ...) {
...
#' @seealso \code{\link{lognormal_distrib}}
S7::method(distrib_hessian, LognormalDistrib) <- function(distrib, y, theta, scale = c("parameter", "link"), ...) {
...
#' @seealso \code{\link{lognormal_distrib}}
S7::method(distrib_expected_hessian, LognormalDistrib) <- function(distrib, y, theta, scale = c("parameter", "link"), approx = c("bartlett", "integrate", "mc", "opg"), nsim = 10000, ...) {
  lognormal_expected_hessian_cpp(y, theta[[1]], theta[[2]])
}

#' @title Lognormal Analytical Third-Order Derivatives
#' @name distrib_deriv3.LognormalDistrib
...
#' @seealso \code{\link{lognormal_distrib}}
S7::method(distrib_deriv3, LognormalDistrib) <- function(distrib, y, theta, expected = FALSE, scale = c("parameter", "link"), approx = c("integrate", "bartlett", "mc", "opg"), nsim = 10000, ...) {
...
#' @name distrib_deriv4.LognormalDistrib
...
#' @seealso \code{\link{lognormal_distrib}}
S7::method(distrib_deriv4, LognormalDistrib) <- function(distrib, y, theta, expected = FALSE, scale = c("parameter", "link"), approx = c("integrate", "bartlett", "mc", "opg"), nsim = 10000, ...) {
...
#' @name distrib_grad_y.LognormalDistrib
#' @description
...
#' @seealso \code{\link{lognormal_distrib}}
S7::method(distrib_grad_y, LognormalDistrib) <- function(distrib, y, theta) {
  r <- log(y) - theta[[1]]
  s2 <- theta[[2]]
  -(1 + r / s2) / y
}
...
#' @name distrib_hess_y.LognormalDistrib
...
#' @return A numeric vector.
#' @seealso \code{\link{lognormal_distrib}}
S7::method(distrib_hess_y, LognormalDistrib) <- function(distrib, y, theta) {
  r <- log(y) - theta[[1]]
  s2 <- theta[[2]]
  (1 + (r - 1) / s2) / y^2
}
